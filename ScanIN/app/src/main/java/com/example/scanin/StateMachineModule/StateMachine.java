...
public class StateMachine {
    static Map<Integer, Integer> HOME_ACTION_NEXT = new HashMap<Integer, Integer>(){{
        ...
        put(MachineActions.HOME_OPEN_PDF, MachineStates.PDF2);
        put(MachineActions.HOME_ADD_SCAN, MachineStates.CAMERA);
    }};

    static Map<Integer, Integer> PDF1_ACTION_NEXT = new HashMap<Integer, Integer>(){{
        put(MachineActions.EDIT_PDF, MachineStates.EDIT_3);
        put(MachineActions.PDF_REORDER, MachineStates.GRID_2);
        put(MachineActions.BACK, MachineStates.GRID_2);
        put(MachineActions.PDF_GO_HOME, MachineStates.ABORT);
    }};
    static Map<Integer, Integer> PDF2_ACTION_NEXT = new HashMap<Integer, Integer>(){{
        put(MachineActions.EDIT_PDF, MachineStates.EDIT_3);
        put(MachineActions.PDF_REORDER, MachineStates.GRID_2);
    ...
    static Map<Integer, Integer> GRID1_ACTION_NEXT = new HashMap<Integer, Integer>() {{
        ...
        put(MachineActions.GRID_OPEN_PDF, MachineStates.PDF1);
    }};
    ...
    static Map<Integer, Map<Integer, Integer>> STATE_ACTION_NEXT = new HashMap<Integer, Map<Integer, Integer>>(){{
        ...
        put(MachineStates.PDF1, PDF1_ACTION_NEXT);
        put(MachineStates.PDF2, PDF2_ACTION_NEXT);
        ...
        put(MachineStates.EDIT_3, EDIT3_ACTION_NEXT);
